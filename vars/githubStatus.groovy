...
def call(String context, String message, String state) {
    ...
    withCredentials([[$class: 'StringBinding', credentialsId: 'GITHUB_TOKEN', variable: 'GITHUB_TOKEN']]) {
        ...
        sh """curl -s --connect-timeout 5 --retry 5 --retry-delay 0 --retry-max-time 60 -H "Authorization: Token ${env.GITHUB_TOKEN}" -H "Accept: application/json" -H "Content-type: application/json" -X POST -d'${payload}' ${apiURL}"""
    }
}
